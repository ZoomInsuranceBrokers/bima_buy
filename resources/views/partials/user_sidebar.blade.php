    ...
    <li class="nav-item nav-profile">
      <a href="#" class="nav-link">
        <div class="nav-profile-image">
          <img src="{{asset('storage/profile_photos/default_photos/male.jpg')}}" alt="profile">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{route('user.pendingLead')}}">Pending leads</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
