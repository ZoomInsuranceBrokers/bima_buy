                                    ...
                                    @forelse ($pendingLeads as $lead)
                                        <tr>
                                            ...
                                            <td> <button type="button" class="btn btn-gradient-info btn-sm"
                                                    onclick="showRemarks({{$lead->id}})">View Remarks</button></td>
                                            <td>
                    ...
                    <form id="updatePaymentFormFirst">
                        <div class="form-group">
                            <div id="aadharPanLinks" class="mb-3">
                                <p id="aadharCardFrontPageLink" style="font-weight: bold;"></p>
                                <p id="aadharCardBackPageLink" style="font-weight: bold;"></p>
                                <p id="panCardLink" style="font-weight: bold;"></p>
                            </div>
                            <div class="form-group" id="paymentLinkInputFirst">
                                <label for="paymentLinkFirst" class="form-label">Enter Payment Link</label>
                                <input type="url" class="form-control" id="paymentLinkFirst" name="paymentLink"
                                    placeholder="Enter Payment Link">
                            </div>

                            <div id="paymentActionFirst1" class="mt-3">
                                <label for="paymentActionFirst" class="form-label">Choose Action</label>
                                <select class="form-control" id="paymentActionFirst" name="paymentAction">
                                    ...
                                    <option value="incomplete_documents">Documents Are Not Clear</option>
                                </select>
                            </div>

                            <div class="form-group d-none mt-3" id="insufficientDetailsMessage1">
                                <label for="insufficientMessage1">Enter your message:</label>
                                <textarea id="insufficientMessage1" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
                    ...
                    <form id="updatePaymentFormSecond">
                        <div class="form-group">
                            ...
                            <div class="form-group d-none mt-3" id="insufficientDetailsMessage2">
                                ...
                                <textarea id="insufficientMessage2" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="policy_start_date"
                                        required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="end_date">Policy End Date<span class="text-danger">*</span></label>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#submitAction').on('click', function () {
                    ...
                    if (action != 'verified' && !message.trim()) {
                    ...
                    $.post(`/leads/action/retail/${leadId}`, {
                        _token: '{{ csrf_token() }}',
                        action: action,
                        message: action != 'verified' ? message : null,
                    }, function (response) {
                        $('#preloader1').hide();
                        if (response.success) {
                    ...
                    $.get(`/payment/screenshort/link/${leadId}`, function (data) {
                        ...
                        if (data.success) {
                            ...
                            if (data.paymentLink) {
                                ...
                                $('#aadharCardFrontPageLink').html(`<strong>Aadhar Card Front Side:</strong> <a href="{{ url('storage/${data.aadhar_card_front_page}') }}" target="_blank">View</a>`);
                                $('#aadharCardBackPageLink').html(`<strong>Aadhar Card Back Side:</strong> <a href="{{ url('storage/${data.aadhar_card_back_page}') }}" target="_blank">View</a>`);
                                $('#panCardLink').html(`<strong>PAN Card:</strong> <a href="{{ url('storage/${data.pan_card}') }}" target="_blank">View</a>`);
                ...
                $('#paymentActionFirst').on('change', function () {
                    const selectedValue = $(this).val();
                    if (selectedValue === 'send_payment_link') {
                        $('#insufficientDetailsMessage1').addClass('d-none');
                    } else {
                        $('#insufficientDetailsMessage1').removeClass('d-none');
                    }
                });
                $('#paymentActionSecond').on('change', function () {
                    const selectedValue = $(this).val();
                ...
                window.submitPaymentActionFirst = function () {
                    ...
                    if (action === 'send_payment_link' && !paymentLink.trim()) {
                        ...
                        const message = $('#insufficientMessage1').val();
                        if (!message.trim()) {
                            Swal.fire('Please enter a message to continue.');
                            return;
                        }
                    ...
                    $.post(`/leads/payment/${leadId}`, {
                        ...
                        message: action != 'send_payment_link' ? $('#insufficientMessage1').val() : null,
                    }, function (response) {
                ...
                window.submitPaymentActionSecond = function () {
                    ...
                    $.post(`/leads/payment/${leadId}`, {
                        _token: '{{ csrf_token() }}',
                        action: action,
                        message: action != 'complete' ? $('#insufficientMessage2').val() : null,
                    }, function (response) {
